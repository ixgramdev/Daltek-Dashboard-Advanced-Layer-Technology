...
!(function (e, t) {
  ...
  (() => {
    ...
    class i {
      ...
      static updateScrollPosition(e, t, s) {
        ...
        const n = e.getBoundingClientRect(),
          ...
          d = o.scrollTop;
        l < 0 && s < 0
          ? e.offsetHeight > r.height
            ? (o.scrollTop += s)
            : (o.scrollTop += Math.abs(l) > Math.abs(s) ? s : l)
          : h > 0 &&
            s > 0 &&
            (e.offsetHeight > r.height
              ? (o.scrollTop += s)
    ...
    class _ extends v {
      ...
      _setupHelper() {
        (this.elOriginStyleVal = _._originStyleProp.map(
          (e) => this.el.style[e],
        )),
      ...
      _cleanHelper() {
        return (
          _._originStyleProp.forEach((e, t) => {
      ...
      setupResizable(e) {
        return (
          this.ddResizable
            ...
            : (this.ddResizable = new _(this.el, e)),
          this
        );
      }
      cleanResizable() {
    ...
    class x {
        ...
        e.forEach((e) => {
          ...
          o > s &&
            (0 === this.engine.nodes.length && this.responseLayout
              ? ((this.engine.nodes = e),
                this.engine.columnChanged(o, s, this.responseLayout),
                (e = this.engine.nodes),
                (this.engine.nodes = []),
          ...
          e === t ||
            ...
            void 0 !== e.row
              ...
              : (void 0 !== e.minRow &&
                ...
                void 0 !== e.maxRow && (t.maxRow = e.maxRow)),
      ...
      _writePosAttr(e, t) {
        return (
          ((t._moving || t._resizing) && this._placeholder !== e) ||
            ((e.style.top = t.y
              ? 1 === t.y
                ? "var(--gs-cell-height)"
          ...
          t.x > 0
            ...
            : e.removeAttribute("gs-x"),
          t.y > 0
            ? e.setAttribute("gs-y", String(t.y))
            : e.removeAttribute("gs-y"),
          t.w > 1
      ...
      prepareDragDrop(e, t = !1) {
        ...
        if (
          (t || r) &&
          (s._initDD && (this._removeDD(e), delete s._initDD),
          r &&
        ...
        if (!s._initDD) {
          ...
          E.draggable(e, { start: n, stop: a, drag: r }).resizable(e, {
            start: n,
            stop: a,
            resize: r,
          }),
      ...
      _dragOrResize(e, t, s, o, n, r) {
        ...
        if (
          ...
          const h =
              s.position.left +
              (s.position.left > o._lastUiPosition.left ? -d : l),
            u =
              s.position.top +
              (s.position.top > o._lastUiPosition.top ? -g : c);
          (a.x = Math.round(h / n)), (a.y = Math.round(u / r));
          ...
          if (
            (this._extraDragRow !== p && this._updateContainerHeight(),
            o.x === a.x && o.y === a.y)
          )
            return;
          ...
          if (
            ...
            (a.w = Math.round((s.size.width - l) / n)),
            (a.h = Math.round((s.size.height - c) / r)),
            o.w === a.w && o.h === a.h)
          )
            return;
          ...
          const d = s.position.left + l,
            g = s.position.top + c;
          (a.x = Math.round(d / n)), (a.y = Math.round(g / r)), (h = !0);
        }
        (o._event = t), (o._lastTried = a);
        const m = {
          x: s.position.left + l,
          y: s.position.top + c,
